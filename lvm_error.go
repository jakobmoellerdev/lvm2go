...
// LVMError is an error that wraps the original error and the stderr output of the lvmBinaryPath command if found.
...
// exitCodeErr is an implementation of LVMError storing the original error and the stderr output of the lvmBinaryPath command.
